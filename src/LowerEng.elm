...
lowerEng = [
  ...
  , lines |> clip (polygon [(20,0.75),(0.75,20),(0.75,93.75),(99.5,93.75),(99.5,0.75)]
      |> filled (rgb 111 105 98) |> move (-85, -55)) 
...
background = group
  ...
  , rect 98.5 15 |> filled (rgb 127 122 106) |> move (-35, 46.5) |> addOutline (solid 1) (rgb 12 21 21)
  ]
...
walls = group
  [
    rect 10 15 |> filled (rgb 93 86 60) |> move (-68, 46.5) |> addOutline (solid 0.75) (rgb 12 21 21)
  , rect 10 15 |> filled (rgb 93 86 60) |> move (5, 46.5) |> addOutline (solid 0.75) (rgb 12 21 21)
  ]
  
hall = group
  [
    rect 40 30 |> filled (rgb 81 77 72) |> move (-28,54) |> addOutline (solid 1) (rgb 12 21 21)
